...
import { login } from './../mines/Server';
			...
			<div className='login-page'>
				...
				<div className='login-form-container'>
					<form className={classNames(
						...
						<input type='text' placeholder='Username' aria-label='username' onChange={(e) => this.change(e, 'username')} />
						<label className='form-input-label'>Password</label>
						<input type='password' placeholder='Password' aria-label='password' onChange={(e) => this.change(e, 'password')} />
					...
					<form className={classNames(
						...
						login && 'form__hidden')}>
						<label className='form-input-label'>Username</label>
						<input type='text' placeholder='Set username' aria-label='username' onChange={(e) => this.change(e, 'username')} />
						<label className='form-input-label'>Email Address</label>
						<input type='email' placeholder='Set email address' aria-label='email' onChange={(e) => this.change(e, 'email')} />
						<label className='form-input-label'>Password</label>
						<input type='password' placeholder='Set password' aria-label='password' onChange={(e) => this.change(e, 'password')} />
						<label className='form-input-label'>Re enter password</label>
						<input type='password' placeholder='Confirm password' aria-label='password' onChange={(e) => this.change(e, 'rePassword')} />
